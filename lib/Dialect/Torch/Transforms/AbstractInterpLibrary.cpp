...
"  }\n"
"  func.func @\"__torch_mlir_shape_fn.aten.linalg_cholesky_ex\"(%arg0: !torch.list<int>, %arg1: !torch.bool, %arg2: !torch.bool) -> !torch.tuple<list<int>, list<int>> {\n"
"    %int1 = torch.constant.int 1\n"
"    %int-2 = torch.constant.int -2\n"
"    %int-1 = torch.constant.int -1\n"
"    %none = torch.constant.none\n"
...
"      torch.prim.If.yield\n"
"    }\n"
"    %5 = torch.aten.slice.t %arg0, %none, %int-2, %int1 : !torch.list<int>, !torch.none, !torch.int, !torch.int -> !torch.list<int>\n"
"    %6 = torch.prim.TupleConstruct %arg0, %5 : !torch.list<int>, !torch.list<int> -> !torch.tuple<list<int>, list<int>>\n"
"    return %6 : !torch.tuple<list<int>, list<int>>\n"
"  }\n"
...
"    return %1 : !torch.int\n"
"  }\n"
"  func.func @\"__torch_mlir_dtype_fn.aten.linalg_cholesky_ex\"(%arg0: !torch.tuple<int, int>, %arg1: !torch.bool, %arg2: !torch.bool) -> !torch.tuple<int, int> {\n"
"    %int3 = torch.constant.int 3\n"
"    %none = torch.constant.none\n"
"    %str = torch.constant.str \"AssertionError: \"\n"
"    %0:2 = torch.prim.TupleUnpack %arg0 : !torch.tuple<int, int> -> !torch.int, !torch.int\n"
...
"      torch.prim.If.yield\n"
"    }\n"
"    %3 = torch.prim.TupleConstruct %0#1, %int3 : !torch.int, !torch.int -> !torch.tuple<int, int>\n"
